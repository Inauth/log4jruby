...
Java::org.apache.logging.log4j.Logger.class_eval do
  ...
  def ruby_logger
    puts self.class
    puts self.class.ruby_logger_lock
...
if Java::org.apache.logging.log4j.Logger.respond_to?(:__persistent__)
  Java::org.apache.logging.log4j.Logger.__persistent__ = true
end
