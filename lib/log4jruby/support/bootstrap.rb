...
Java::org.apache.logging.log4j.core.Logger.class_eval do
...
if Java::org.apache.logging.log4j.core.Logger.respond_to?(:__persistent__)
  Java::org.apache.logging.log4j.core.Logger.__persistent__ = true
end
