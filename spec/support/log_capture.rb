shared_context 'log capture', :log_capture => true do
  ...
  before do
    ...
    layout = Java::org.apache.logging.log4j.PatternLayout.new('%5p %.50X{fileName} %X{methodName}:%X{lineNumber} - %m%n')
    appender = Java::org.apache.logging.log4j.WriterAppender.new(layout, @log_stream)
